...
public class Assignment1_2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("reg_email_confirmation__")).sendKeys("dhaatri1921@gmail.com");
		...
		// Purposely giving unacceptable year so that it does not submit and create the
		// account
